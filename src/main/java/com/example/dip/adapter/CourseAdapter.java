...
import com.example.dip.CoursePage;
...
public class CourseAdapter extends RecyclerView.Adapter<CourseAdapter.CourseViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CourseViewHolder holder, int position) {
        ...
        holder.courseFak.setText(courses.get(position).getFak());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("courseFak", courses.get(position).getFak());
    ...
    public static final class CourseViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView courseTitle, courseLevel, courseFak;
        ...
        public CourseViewHolder(@NonNull View itemView) {
            ...
            courseFak = itemView.findViewById(R.id.courseFak);
        }
    }
